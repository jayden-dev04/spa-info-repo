  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-5xl">
      ...
      <div className="text-center mb-12 space-y-3">
        ...
        <h1 className="text-3xl sm:text-4xl font-heading font-bold text-primary">Góc Dưỡng Sinh & Làm Đẹp Tự Nhiên</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {filteredPosts.map((post: any) => (
          <Card key={post.id} className="hover:border-primary/50 hover:shadow-lg transition-all duration-300 group rounded-2xl border-border/80 overflow-hidden bg-card flex flex-col">
            {/* Post Thumbnail */}
            {post.featuredImage && (
            ...
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-lg font-heading font-bold text-foreground group-hover:text-primary transition-colors leading-snug line-clamp-2">
                {post.title}
              </CardTitle>
            </CardHeader>
